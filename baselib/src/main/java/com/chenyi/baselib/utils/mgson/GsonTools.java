package com.chenyi.baselib.utils.mgson;
                    ...
                    switch (type) {
                        case 0:
                            if (in.peek() == JsonToken.STRING) {
                                //暂不做处理
                                return StringUtil.stringToInteger(in.nextString());
                            }
                            return in.nextInt();
                        case 1:
                            if (in.peek() == JsonToken.STRING) {
                        ...
                        case 2:
                            if (in.peek() == JsonToken.STRING) {
                                //暂不做处理
                                return StringUtil.stringToLong(in.nextString());
                            }
                            return in.nextLong();
                        case 3:
                            if (in.peek() == JsonToken.STRING) {
                                //暂不做处理
                                return StringUtil.stringToDouble(in.nextString());
                            }
                            return in.nextDouble();
                        case 4:
                            if (in.peek() == JsonToken.STRING) {
                                //暂不做处理
                                return StringUtil.stringToFloat(in.nextString());
                            }
