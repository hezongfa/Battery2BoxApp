...
public class LanguageContextWrapper extends ContextWrapper {
    ...
    public static ContextWrapper wrap(Context context, Locale languageLocale) {
...
//            }
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            setSystemLocale(config, languageLocale);
        } else {
            setSystemLocaleLegacy(config, languageLocale);
        }
