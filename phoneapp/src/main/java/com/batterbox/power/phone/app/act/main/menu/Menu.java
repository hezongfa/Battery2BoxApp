...
//                    Intent intent = new Intent(BatterBoxApp.getInstance(), StartC2CChatActivity.class);
//                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
//                    mActivity.startActivity(intent);
//                }

//                if (TextUtils.equals(action.getActionName(), mActivity.getResources().getString(R.string.create_private_group))) {
//                    Intent intent = new Intent(BatterBoxApp.getInstance(), StartGroupChatActivity.class);
//                    intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
